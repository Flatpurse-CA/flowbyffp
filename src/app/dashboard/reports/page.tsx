  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
      ...
      <div style={{ display: "flex", justifyContent: "space-between" }}>
        {labels.map((l) => (
          <span key={l} style={{ color: "rgba(255,255,255,0.25)", fontSize: 10 }}>{l}</span>
        ))}
      </div>
    </div>
  );
    ...
    <div style={{ display: "flex", alignItems: "flex-end", gap: 6, height: 80 }}>
      {data.map((v, i) => (
        <div key={i} style={{ flex: 1, display: "flex", flexDirection: "column", alignItems: "center", gap: 4 }}>
          ...
          <span style={{ color: "rgba(255,255,255,0.3)", fontSize: 9 }}>{labels[i]}</span>
        </div>
      ))}
    </div>
  );
  ...
  return (
    <div style={{ maxWidth: 1280, margin: "0 auto", display: "flex", flexDirection: "column", gap: 22 }}>
        ...
        {[
          ...
          <div key={label} style={card}>
            <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", marginBottom: 12 }}>
              <p style={{ color: "rgba(255,255,255,0.38)", fontSize: 12, margin: 0 }}>{label}</p>
            ...
            <p style={{ color: "rgb(250,250,250)", fontSize: 28, fontWeight: 800, margin: "0 0 6px", letterSpacing: "-0.04em", lineHeight: 1 }}>{value}</p>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 340px", gap: 14 }}>
        ...
        <div style={card}>
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 20 }}>
            <div>
              <p style={{ color: "rgb(250,250,250)", fontSize: 14, fontWeight: 700, margin: "0 0 3px" }}>Revenue performance</p>
              <p style={{ color: "rgba(255,255,255,0.3)", fontSize: 12, margin: 0 }}>Monthly revenue Jul 2025 – Jun 2026</p>
            </div>
        ...
        {/* Top services */}
        <div style={card}>
          <p style={{ color: "rgb(250,250,250)", fontSize: 14, fontWeight: 700, margin: "0 0 16px" }}>Top services</p>
          <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
            {TOP_SERVICES_REPORT.map((s) => (
              <div key={s.name}>
                <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 5 }}>
                  <span style={{ color: "rgb(250,250,250)", fontSize: 13, fontWeight: 600 }}>{s.name}</span>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 14 }}>
        ...
        {/* Bookings bar chart */}
        <div style={card}>
          <p style={{ color: "rgb(250,250,250)", fontSize: 14, fontWeight: 700, margin: "0 0 4px" }}>Monthly bookings</p>
          <p style={{ color: "rgba(255,255,255,0.3)", fontSize: 12, margin: "0 0 20px" }}>{MONTHLY_BOOKINGS.reduce((a,b)=>a+b,0)} total this year</p>
