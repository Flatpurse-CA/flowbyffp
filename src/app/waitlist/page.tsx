...
const FAQS = [
  ...
  { n: "06", q: "What happens after the 40 beta spots fill?",                      a: "The Founder Beta program closes permanently once the first 40 businesses join — there is no second wave. Founder Beta members get 40% off their first 12 months and 25% off for life after that, as long as they keep an active subscription. Cancel and come back later? You lose the Founder pricing permanently. Every business that joins after launch pays standard FlatPurse Flow pricing, no exceptions." },
        ...
        <div style={{ position: "relative", zIndex: 1 }}>
          ...
          <div style={{ marginBottom: 72, textAlign: "center" }}>
            ...
            <h2 ref={howRef} style={{
              ...
              {["See", "exactly", "how", "a", "salon"].map((word, i) => (
