        ...
        <div style={{ width: "100%", maxWidth: 400, animation: `0.42s ${easing} 0s 1 normal both running fp-slide-in-r` }}>
          ...
          <form onSubmit={submit} style={{ display: "flex", flexDirection: "column", animation: fadeUp(80) }}>
            ...
            <div style={{ marginBottom: 8 }}>
              ...
              <div style={{ position: "relative" }}>
                <input
                  ...
                  placeholder="Enter your password" autoComplete="current-password" style={{ ...inputStyle, paddingRight: 44 }}
                />
                <button
            ...
            <div style={{ textAlign: "right", marginBottom: 20 }}>
              <Link href="/customer/forgot-password" style={{ fontSize: 12, color: "var(--auth-text-sub)", textDecoration: "none" }}>
                Forgot password?
              </Link>
            </div>
          ...
          <p style={{ color: "var(--auth-text-sub)", fontSize: 13, textAlign: "center", marginTop: 20, animation: fadeUp(260) }}>
            New here?{" "}
            <Link href={`/customer/signup?next=${encodeURIComponent(next)}`} style={{ color: "rgb(107,99,232)", fontWeight: 600, textDecoration: "none" }}>
              Create an account
            </Link>
          </p>
        </div>
